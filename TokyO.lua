...
SUDO = SUDO
sudo_users = {SUDO,911945965,911945965}   
print([[
  ---------------------------------------------
  |     _______       _   ____   __           |
  |    |__   __|___  | | / /\ \ / / ___       |
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTokyOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(911945965) then  
var = true  
elseif tonumber(user_id) == tonumber(911945965) then
var = true  
...
local UserName = (data.username_ or "TOKYO_TEAM")
...
local TokyO_Msg = ''  
if msgs < 100 then 
TokyO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
TokyO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
TokyO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TokyO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
TokyO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TokyO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TokyO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
TokyO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
TokyO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TokyO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TokyO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TokyO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
TokyO_Msg = 'رب التفاعل'  
end 
return TokyO_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@MFMVIP")  
...
--------------------------------------------------------------------------------------------------------------
function SourceTokyO(msg,data) -- بداية العمل صــــــوفي 
if msg then
...
local list = database:smembers(bot_id.."TokyO1:List:Filter"..sl)
...
if not DevTokyOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTokyOW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,TokyO_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✘' and DevTokyOW(msg) then  
...
if text == 'تعطيل التواصل ✘' and DevTokyOW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✘' and DevTokyOW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✘' and DevTokyOW(msg) then  
...
if text == 'ضع كليشه ستارت ✘' and DevTokyOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✘ ∫ ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✘' and DevTokyOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✘ ∫ تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✘' and DevTokyOW(msg) then 
...
if text == 'الاصدار ✘' and DevTokyOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✘ ∫ اصدار سورس طوكيو* \n*✘ ∫ الاصدار »{ 2.0v}*')
end
if text == 'قناه تحديثات البوت ✘' and DevTokyOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✘ ∫ [تحديثات البوت](t.me/TOKYO_TEAM) \n✘ ∫ [قناه السورس](t.me/TOKYO_TEAM)')
end
if text == "ضع اسم للبوت ✘" and DevTokyOW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✘' and DevTokyOW(msg) then 
...
if text == 'المشتركين ✘' and DevTokyOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✘ ∫ المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✘' and DevTokyOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✘ ∫ الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✘") and DevTokyOW(msg) then
...
if text == ("قائمه العام ✘") and DevTokyOW(msg) then
...
if text == ("قائمه الكتم العام ✘") and DevTokyOW(msg) then
...
if text=="اذاعه خاص ✘" and msg.reply_to_message_id_ == 0 and DevTokyOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل الان اذاعتك؟* \n*✘ ∫ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✘" and msg.reply_to_message_id_ == 0 and DevTokyOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل الان اذاعتك؟* \n*✘ ∫ للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✘" and msg.reply_to_message_id_ == 0 and DevTokyOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل الان اذاعتك؟* \n*✘ ∫ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✘" and msg.reply_to_message_id_ == 0  and DevTokyOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✘" and msg.reply_to_message_id_ == 0  and DevTokyOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✘ ∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✘' and DevTokyOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✘" and DevTokyOW(msg) then
...
if text == "تنظيف الكروبات ✘" and DevTokyOW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✘ ∫ عدد الكروبات الان » { '..#group..' }'..TokyOk..''..TokyO..'*\n*✘ ∫ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTokyOW(msg) then
...
usertext = '*\n ✘ ∫ اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'TOKYO_TEAM')..')'
status  = '\n *✘ ∫ تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevTokyOW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✘ ∫ اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TOKYO_TEAM')..')'
status  = '\n*✘ ∫ تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTokyOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTokyOW(msg) then
...
local TokyO1_Msg = database:get(bot_id.."TokyO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TokyO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✘ ∫ اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TOKYO_TEAM')..') \n ✘ ∫ '..TokyO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://MFMVIIP.ml/amir00/captcha.php?c='..captcha..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end 
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------
if TokyO_Msg and not Special(msg) then  
local TokyO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TokyO_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✘ ∫ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✘ ∫ ["..TokyO_Msg.."] \n")
else
send(msg.chat_id_,0," *✘ ∫ العضو :* {["..data.first_name_.."](T.ME/TOKYO_TEAM)}\n✘ ∫ ["..TokyO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✘ ∫ عذرا ↫* {["..data.first_name_.."](T.ME/TOKYO_TEAM)}\n*✘ ∫ عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTokyOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTokyOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTokyOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✘ ∫ حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTokyOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✘ ∫ حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✘" and DevTokyOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✘ ∫ تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✘$") and DevTokyOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✘ ∫ حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✘" and DevTokyOW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✘" and DevTokyOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✘ ∫ تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✘" and DevTokyOW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."TokyO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."TokyO:blocname"..msg.chat_id_)
...
function MFMVIIP_name(t1,t2)
if t2.id_ then 
name_TokyO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_TokyO then 
names_TokyO = database:smembers(bot_id.."TokyO:blocname"..msg.chat_id_) or ""
if names_TokyO and names_TokyO[1] then 
for i=1,#names_TokyO do 
if name_TokyO:match("(.*)("..names_TokyO[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, MFMVIIP_name)
end
...
database:set(bot_id.."TokyO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."TokyO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."TokyO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."TokyO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."TokyO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_TokyOa_new(TokyO1,TokyO2)
if TokyO2 and TokyO2.first_name_ then 
if TokyO2.first_name_:match("(.*)"..database:get(bot_id.."TokyO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TokyO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local TokyO_nnn = database:get(bot_id.."TokyO:nump"..msg.chat_id_) or 5
local TokyO_nnn2 = database:get(bot_id.."TokyO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(TokyO_nnn2) == tonumber(TokyO_nnn) or tonumber(TokyO_nnn2) > tonumber(TokyO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."TokyO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✘ ∫ عزيزي >>["..TokyO2.username_.."](https://t.me/"..(TokyO2.username_ or "TOKYO_TEAM")..")\n✘ ∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."TokyO:teh"..msg.chat_id_).."} بجانب اسمك\n✘ ∫ عدد المحاولات المتبقيه {"..(tonumber(TokyO_nnn) - tonumber(TokyO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_TokyOa_new)
end
end
...
local TokyOChengName = database:get(bot_id.."TokyO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TokyOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TokyOChengName..']')
database:del(bot_id.."TokyO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TokyOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."TokyO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TokyOChengUserName = database:get(bot_id.."TokyO:Cheng:UserName"..data.id_)
if not data.username_ then 
if TokyOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TokyOChengUserName..']')
database:del(bot_id.."TokyO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TokyOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."TokyO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TokyOChengPhoto = database:get(bot_id.."TokyO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TokyOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."TokyO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TokyOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."TokyO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, '*✘ ∫ بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TOKYO_TEAM')..') \n*✘ ∫ تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✘ ∫ بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TOKYO_TEAM')..') \n*✘ ∫ تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ صــــــوفي 
if text == 'تحديث' and DevTokyOW(msg) then
dofile('TokyO.lua')  
send(msg.chat_id_, msg.id_, ' *✘ ∫ تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevTokyOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTokyOW(msg) then  
function start_function(extra, result, success)
if TokyOSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevTokyOW(msg) then  
...
if TokyOSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✘ ∫ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevTokyOW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if TokyOSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✘ ∫ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTokyOW(msg) then  
function start_function(extra, result, success)
if TokyOSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✘ ∫ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevTokyOW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevTokyOW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if TokyOSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✘ ∫ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTokyOW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTokyOW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevTokyOW(msg) then  
...
------------------------------------------------------------------------ صــــــوفي 
if text == ("مسح المطورين") and DevTokyOW(msg) then
...
if database:get(bot_id.."MFMVIIP:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'MFMVIIP:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevTokyOW(msg) then
t = ' *✘ ∫ ملفات السورس طوكيو ↓*\n*⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n *✘ ∫ اهلا بك في متجر ملفات طوكيو*\n*✘ ∫ ملفات السورس ↓*\n*⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n\n"
local TextE = "\n*⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n *✘ ∫ علامة تعني { ✓ } ملف مفعل*\n *✘ ∫ علامة تعني { ✘ } ملف معطل*\n *✘ ∫ قناة سورس طوكيو ↓*\n".." *✘ ∫ *[اضغط هنا لدخول](t.me/TOKYO_TEAM) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTokyOW(msg) then
...
send(msg.chat_id_, msg.id_," *✘ ∫ عذرا الملف لايدعم سورس طوكيو* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTokyOW(msg) then
...
if text == "مسح الملفات" and DevTokyOW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✘ ∫ تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTokyOW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTokyOW(msg) then  
function start_function(extra, result, success)
...
st = https.request('https://MFMVIIP.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://MFMVIIP.ml/Imagelnfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local UserName = (b.username_ or "TOKYO_TEAM")
...
function Function_TokyO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TokyO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TokyO, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✘ ∫ العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'TOKYO_TEAM')..')'
status  = '\n*✘ ∫ تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✘ ∫ لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TOKYO_TEAM')..')'
status  = '\n*✘ ∫ تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✘ ∫ اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✘ ∫ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TOKYO_TEAM')..')'
...
database:set(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TokyO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TokyO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✘ ∫ تم منع الكلمه مع التحذير*")  
database:del(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TokyO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TokyO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TokyO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✘ ∫ ارسل الكلمه الان*")  
database:set(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TokyO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TokyO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TokyO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TokyO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TokyO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TokyO1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevTokyOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✘ ∫ تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevTokyOW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✘ ∫ اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'TOKYO_TEAM')..')'..'\n*✘ ∫ تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevTokyOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTokyOW(msg) then  
...
if not database:get(bot_id..'MFMVIIP:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'MFMVIIP:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'طوكيو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'طوكيو')
local TokyO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..TokyO_Msg[math.random(#TokyO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTokyOW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,TokyO)
local t = "\n*ツ قائمة الاعضاء* \n*⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n"
x = 0
local list = TokyO.members_
for k, v in pairs(list) do
x = x + 1
...
if TokyOSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevTokyOW(msg) then 
...
if text == ("ردود المطور") and DevTokyOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✘ ∫ قائمة ردود المطور \n*⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTokyOW(msg) then    
send(msg.chat_id_, msg.id_,' *✘ ∫ ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevTokyOW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'طوكيو').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevTokyOW(msg) then   
...
if text == 'تعطيل المغادره' and DevTokyOW(msg) then  
...
-- vardump(data) 
TokyOdx(msg.chat_id_, msg.id_, ' *✘ ∫ ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✘ ∫ عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✘ ∫ عدد المحظورين » ( '..data.kicked_count_..' )*\n*✘ ∫ عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTokyOW(msg) then
...
{{text = '- sᴏᴜʀᴄʀ ᴛᴏᴋʏᴏ', url="t.me/TOKYO_TEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '⋄ sᴏᴜʀᴄʀ ᴛᴏᴋʏᴏ', url="t.me/TOKYO_TEAM"}},
{{text = 'مطور السورس', url="t.me/MFMVIP"}},
}
...
zh = https.request('https://TokyO-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*✘ ∫ قائمه الزخرفه* \nٴ✘∫ٴ*⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*ٴ✘∫○ٴ \n"
i = 0
...
gk = https.request('https://TokyO-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://TokyO-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://TokyO-api.ml/audios.php')
if res == 200 then
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴏᴋʏᴏ',url='http://t.me/TOKYO_TEAM'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'طوكيو')
...
TokyO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TokyO)
...
--------------------------------------------------------------------------------------------------------------
SourceTokyO(data.message_,data)
...
------------------------------------------------------------------------
local TokyOAbot = database:get(bot_id.."TokyO1:Add:Filter:Rp2"..text..result.chat_id_)   
if TokyOAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✘ ∫ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✘ ∫ ["..TokyOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TokyO1_Msg = database:get(bot_id.."TokyO1:Add:Filter:Rp2"..text..result.chat_id_)   
if TokyO1_Msg then
send(msg.chat_id_, msg.id_," ✘ ∫ "..TokyO1_Msg)
