...
print([[
  ...
  |  This Is The Source Channel @TOKYO_TEAM . |
  |               - TOKYO -                   |
  ---------------------------------------------
]])
